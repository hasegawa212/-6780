...
PRESETS: dict[str, list[str]] = {
    ...
    # 全宅連/標準様式の重要事項説明書（35条書面）の主要ラベル。
    # 様式が違っても語彙はほぼ共通なので、新様式の当たり付けに使える。
    "juyojiko": [
        "宅地建物取引業者", "免許証番号", "取引士", "登録番号",
        "取引態様", "売主", "買主", "所在", "地番", "地目", "地積",
        "家屋番号", "床面積", "構造", "登記記録", "所有権",
        "都市計画", "市街化", "用途地域", "建蔽率", "容積率", "防火",
        "高度地区", "道路", "私道", "飲用水", "ガス", "排水", "電気",
        "管理費", "修繕積立金", "管理組合", "造成宅地", "土砂災害",
        "津波", "建築確認", "検査済証", "売買代金", "手付金", "違約金",
        "契約不適合", "容認事項", "特約",
    ],
}
# 全宅連様式も標準重説と語彙はほぼ同じため juyojiko プリセットを共用する。
PRESETS["zentaku"] = PRESETS["juyojiko"]
