...
# 34-1/35-1（売買代金清算＝測量/確定測量）は重説が36-1と座標完全一致（相乗り可）。
# ただし契約書シートは36-1と別レイアウトのため、契約書は cellmaps 側で内蔵生成にフォールバックさせる。
# 31-1/33-1（土地。33=固定/31=清算）: 重説は36-1ベースを行変換して差込（land builder）。
_VARIANT_MARKERS = {"31-1": "31-1", "33-1": "33-1", "34-1": "34-1", "35-1": "35-1",
                    "36-1": "36-1", "37-1": "37-1", "38-1": "38-1", "16-1": "16-1"}
