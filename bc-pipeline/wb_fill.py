...
# 35-1 は 36-1 と重説/契約書のセル座標が完全一致（全宅連 土地建物・売主宅建業者用。
# 相違は代金清算＝確定測量 vs 固定の条項文言のみ）。36-1 のマッピングに相乗りする。
_VARIANT_MARKERS = {"35-1": "35-1", "36-1": "36-1", "37-1": "37-1", "38-1": "38-1", "16-1": "16-1"}
