...
# ===== 完成済みExcel検証済みセルマップ（牛久市南7-53-35）=====
# このマップは実際の完成品から抽出した正解セル位置
VERIFIED_CELL_MAP = {'重要事項説明書': {'買主名': 'F7', '免許番号': 'S21', '代表者': 'H31', '宅建士': 'H35', '物件所在地_土地1': 'D194', '物件所在地_土地2': 'D196', '物件所在地_建物1': 'G236', '物件所在地_建物2': 'G238', '登記名義人住所': 'L288', '登記乙区_土地': 'L296', '登記名義人住所_建物': 'L308', '登記乙区_建物': 'L316'}, '不動産売買契約書': {'土地所在1': 'F11', '土地所在2': 'F13', '建物所在': 'I23', '売主': 'E123', '買主': 'AB123'}}
